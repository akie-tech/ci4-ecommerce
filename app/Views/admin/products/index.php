            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body table-responsive p-0">
                        <?= $this->include('admin/shared/flash_message') ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if (empty($product->deleted_at)) : ?>
                                                    ...
                                                    <form action="<?= site_url('admin/products/' . $product->id) ?>" method="POST" accept-charset="UTF-8" class="delete" style="display: inline-block;">
