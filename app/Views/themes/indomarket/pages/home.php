        ...
        <div class="row mt-4">
                ...
                <div class="single-product">
                    <div class="product-img">
                        <a href="product-detail.html">
                            <img src="<?= base_url('themes/' . $currentTheme) ?>/assets/img/products/p1.jpg" class="img-fluid" />
                        </a>
                    </div>
            ...
            <div class="col-xl-3 col-lg-4 col-md-4 col-12">
                <div class="single-product">
                    <div class="product-img">
                        <a href="product-detail.html">
                            <img src="<?= base_url('themes/' . $currentTheme) ?>/assets/img/products/p2.jpg" class="img-fluid" />
                        </a>
                    </div>
                    <div class="product-content">
                        <h3><a href="product-detail.html">Cool &amp; Awesome Item</a></h3>
            ...
            <div class="col-xl-3 col-lg-4 col-md-4 col-12">
                <div class="single-product">
                    <div class="product-img">
                        <a href="product-detail.html">
                            <img src="<?= base_url('themes/' . $currentTheme) ?>/assets/img/products/p3.jpg" class="img-fluid" />
                        </a>
                    </div>
                    <div class="product-content">
                        <h3><a href="product-detail.html">Cool &amp; Awesome Item</a></h3>
            ...
            <div class="col-xl-3 col-lg-4 col-md-4 col-12">
                <div class="single-product">
                    <div class="product-img">
                        <a href="product-detail.html">
                            <img src="<?= base_url('themes/' . $currentTheme) ?>/assets/img/products/p4.jpg" class="img-fluid" />
                        </a>
                    </div>
                    <div class="product-content">
                        <h3><a href="product-detail.html">Cool &amp; Awesome Item</a></h3>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 text-md-right">
                <a href="#"><img src="<?= base_url('themes/' . $currentTheme) ?>/assets/img/appstore.png" height="40"></a>
                <a href="#"><img src="<?= base_url('themes/' . $currentTheme) ?>/assets/img/appstore.png" height="40"></a>
            </div>
        </div> <!-- row.// -->
    </div><!-- container // -->
