                    ...
                    <ul class="top-links account-links">
                        <?php if ($auth->loggedIn()) : ?>
                            <?php if ($auth->inGroup(['admin', 'operator'], $currentUser->id)) : ?>
                                <li><i class="fa fa-home"></i> <a href="<?= base_url('admin/dashboard') ?>">Dashboard</a></li>
                            <?php endif ?>
                            <li><i class="fa fa-user-circle-o"></i> <a href="<?= base_url('auth') ?>">My Account</a></li>
                            <li><i class="fa fa-power-off"></i> <a href="<?= base_url('auth/logout') ?>">Logout</a></li>
                        <?php else : ?>
